...
describe('createResource', () => {
  it('should create resource with auto-generated ID', () => {
    ...
    expect(resource._urn).toMatch(/^urn:pp:System\.Account::/);
    expect(resource.PK).toBe(`Resource#${resource._urn}`);
    expect(resource.SK).toBe(`Resource#${resource._urn}`);
  ...
  it('should create resource with provided ID', () => {
    ...
    expect(resource._urn).toBe(`urn:pp:System.Account::${id}`);
  });
